...
export async function createTokenSwap(
  ...
  owner = new Account([163,61,232,225,108,114,83,130,116,95,208,240,30,46,182,34,108,167,203,53,77,22,57,210,148,181,254,234,60,152,119,254,69,2,16,113,24,42,138,49,186,164,58,111,125,213,36,239,26,102,218,31,252,40,132,48,143,8,44,47,88,141,147,44]);
  ...
  let mintA = findAssociatedTokenAddress(owner.publicKey,new PublicKey("4zMMC9srt5Ri5X14GAgXhaHii3GnPAEERYPJgZJDncDU"))
  console.log(mintA)
